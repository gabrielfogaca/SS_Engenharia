...
function EmpreasaParceiras() {
  return (
    <div
      ...
      id="localizacao"
    >
      <div className="flex space-x-4 sm:space-x-8 md:space-x-12 lg:space-x-16 gap-2 sm:gap-4 mb-8 animate-loop-scroll group-hover:pause">
        <img
          src={emp1}
          alt=""
      ...
      <div
        className="flex space-x-4 sm:space-x-8 md:space-x-12 lg:space-x-16 gap-2 sm:gap-4 mb-8 animate-loop-scroll group-hover:pause"
        aria-hidden="true"
      >
        <img
          src={emp1}
